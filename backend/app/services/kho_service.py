    ...
    def kiem_tra_va_lock_so_luong(self, items: List[Dict]) -> tuple[bool, List[Dict], str]:
        ...
        try:
            ...
            for item in items:
                ...
                if variant.so_luong < so_luong_yc:
                    return False, [], f"Sản phẩm {variant.san_pham.ten_san_pham} - {variant.ten_bien_the} không đủ số lượng"
                ...
                available_quantity = variant.so_luong - locked_quantity
