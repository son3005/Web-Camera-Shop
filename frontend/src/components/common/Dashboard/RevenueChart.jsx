...
function RevenueChart() {
    ...
    return (
        <div className="bg-white dark:bg-slate-900/80 backdrop-blur-xl rounded-b-2xl border
        border-slate-200/50 dark:border-slate-700/50 p-6">
                ...
                <div className="flex items-center space-x-4">
                    <div className="flex items-center space-x-2">
                        ...
                        <div className="text-sm text-slate-600 dark:text-slate-400">
                            <span>Revenue</span> {/* Sửa lại tên cho ngắn gọn */}
                        </div>
                    </div>
                    <div className="flex items-center space-x-2">
            ...
            {/* SỬA 1: ResponsiveContainer phải bọc BarChart */}
            <div className="h-80">
                <ResponsiveContainer width="100%" height="100%">
                    ...
                    >
                        {/* SỬA 2: Sửa tên component và các props */}
                        <CartesianGrid
                            strokeDasharray="3 3"
                            stroke="#e2e8f0" // SỬA 3: Sửa mã màu
                            opacity={0.3}
                        />
                        <XAxis
                            dataKey="month"
                        ...
                        <YAxis
                            ...
                            tickLine={false}
                            axisLine={false}
                            tickFormatter={(value) => `$${value / 1000}k`} // Gợi ý: Format YAxis cho đẹp hơn
                        />
                        <Tooltip
                            contentStyle={{
                                ...
                                border: "none",
                                borderRadius: "12px",
                                boxShadow: "0 10px 40px rgba(0, 0, 0, 0.1)", // SỬA 3: Sửa giá trị shadow
                            }}
                            formatter={(value) => [`$${value.toLocaleString()}`, ""]}
                        />
                        <defs>
                             {/* SỬA 4: Xóa dấu # trong id */}
