...
// Cấu hình menu chính (icon, label, badge, submenu...)
const menuItems = [
...
function Sidebar({ collapsed, currentPage, onPageChange }) {
  // State lưu item nào đang expand submenu
  const [expandedItems, setExpandedItems] = useState(new Set(["analytics"]));

  // Toggle expand/collapse cho submenu
    ...
    >
      ...
      <div className="p-6 border-b border-slate-200/50 dark:border-slate-700/50">
        <div className="flex items-center space-x-3">
          ...
          {/* Hiện text khi sidebar không collapsed */}
          {!collapsed && (
            <div>
          ...
          return (
            <div key={item.id}>
              ...
              >
                ...
                {/* Chevron hiển thị khi có submenu */}
              ...
              {/* Submenu (chỉ hiện khi expanded + không collapsed) */}
      ...
      {/* User Profile (chỉ hiện khi sidebar mở rộng) */}
      {!collapsed && (
