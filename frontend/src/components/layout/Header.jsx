...
export default function Header() {
  ...
  return (
    <header className="fixed top-0 left-0 w-full z-50 bg-slate-900/90 backdrop-blur-md border-b border-slate-700 shadow-sm">
      <div className="container mx-auto px-4 h-16 flex items-center gap-3 text-slate-100">
        {/* Hamburger (mobile) */}
        <button
        ...
        <form onSubmit={submit} className="flex-1 max-w-xl">
          <input
            className="w-full px-4 py-2 rounded-full bg-slate-800 text-slate-100 border border-slate-600 placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-emerald-500 transition"
        ...
        <div className="flex items-center gap-2">
          <a
            href="tel:19001234"
            className="hidden md:flex items-center gap-1 text-sm text-slate-300 hover:text-emerald-400"
          >
      ...
      >
        ...
        {/* panel */}
        <aside
          className={`absolute left-0 top-0 h-full w-80 max-w-[85%] bg-slate-900 border-r border-slate-700 shadow-2xl p-4 flex flex-col gap-4 transition-transform ${
        ...
        >
          ...
          <form onSubmit={submit}>
            <input
              className="w-full px-4 py-2 rounded-lg bg-slate-800 text-slate-100 border border-slate-600 placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-emerald-500"
